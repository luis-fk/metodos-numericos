...
def main():
    ...
    data = np.loadtxt('inputs-outputs/exponencial.txt')
    ...
    plt.plot(t, exp_function(t), label="Exponential Function", color='black')
    plt.savefig('imagens/splines/splineVinculadoExponencial.png')
